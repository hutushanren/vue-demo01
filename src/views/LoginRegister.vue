<template>
  <div class="container" :class="{ 'sign-up-mode': signUpMode }">
    ...
    <div class="form-container">
      ...
      <!-- 登录  -->
        <LoginForm :login-user="loginUser" :rules="rules"></LoginForm>
        <RegisterForm :register-rules="registerRules" :register-user="registerUser"></RegisterForm>
      </div>
    </div>
    <!-- 左右切换动画 -->
...
export default {
  ...
  setup() {
    ...
    return { loginUser, rules, signUpMode, registerUser, registerRules }
  }
}
</script>
<style scoped>
